...
// RemoveNodeResources removes "res" from nodeAvailableResources
func RemoveNodeResources(nodeAvailableResources *[]*api.GenericResource, res []*api.GenericResource) {
...
// Returns true if the element should be removed from the list
